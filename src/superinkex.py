...
Copyright (C) 2018 Kristian Benoit, kristian.benoit@gmail.com and inkex contributors

inkex contributors:
  2005,2010 Aaron Spike <aaron@ekips.org>
...
class Exscape:
    """The main class of this extension from where you access all the rest."""
